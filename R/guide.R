...
'down. Strong coordinated movement means the program is on. The result is a normalized enrichment ',
...
'patient&rsquo;s actual value. The KM throws that away and dichotomizes at the median, purely to ',
